...
export const FreedomSale = () => {
        const [images,setImages]=useState([])
            useEffect(()=>{
                fetch("/data/product.json")
                .then((response)=>{return response.json()})
                .then((img)=>{
                    return setImages(img.sales2)
                })
            },[])
            console.log(images)
          return (
            ...
            <div>
                <div className='sales-wrapper'>
                   <img src="https://rukminim2.flixcart.com/fk-p-flap/920/380/image/920f065330d09076.jpg?q=60" className='sales-img' alt="" />
