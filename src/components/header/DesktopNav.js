    ...
    <div className='des-nav-wrapper'>
        <div className='des-nav-inner'>
            <div className='desktop-logo'>
               <div className='desk-filp'><img src="https://static-assets-web.flixcart.com/batman-returns/batman-returns/p/images/fkheaderlogo_exploreplus-44005d.svg" width="160" height="40" title="Flipkart"></img></div>
        ...
        <div className='logo'>
            <div className='desk-extra login-desk'>
            <a href="#" className='login des-mar'><img src="https://static-assets-web.flixcart.com/batman-returns/batman-returns/p/images/profile-52e0dc.svg" alt="Login" class="_1XmrCc _2zJ7Pb" width="24" height="24"></img></a>
